...
import TranVachThachCaoPage from '../pages/thi-cong/tran-vach-thach-cao';
import SanGoPage from '../pages/thi-cong/san-go';
import DaOpLatPage from '../pages/thi-cong/da-op-lat';

// Import remaining pages (placeholders for now - to be created)
const NhomKinhPage = React.lazy(() => import('../pages/thi-cong/nhom-kinh'));
const CuaCompositePage = React.lazy(() => import('../pages/thi-cong/cua-composite'));
const DienMatTroiPage = React.lazy(() => import('../pages/thi-cong/dien-mat-troi'));
const DienThongMinhPage = React.lazy(() => import('../pages/thi-cong/dien-thong-minh'));
const HoKoiSanVuonPage = React.lazy(() => import('../pages/thi-cong/ho-koi-san-vuon'));
const RemCuaPage = React.lazy(() => import('../pages/thi-cong/rem-cua'));
const ChongThamPage = React.lazy(() => import('../pages/thi-cong/chong-tham'));
const PhaoChiPage = React.lazy(() => import('../pages/thi-cong/phao-chi'));
